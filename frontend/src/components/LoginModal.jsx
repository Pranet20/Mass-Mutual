...
import { Lock, Mail, User, AlertCircle, ShieldCheck, UserCheck, UserPlus, Building2, Briefcase } from 'lucide-react';
...
export const LoginModal = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      await googleLogin(googleEmail.trim(), formattedName);
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-md p-4">
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden transition-all">
        {/* Brand Header */}
          ...
          {activeTab === 'employee' && (
            <form onSubmit={handleEmployeeSubmit} className="space-y-4">
              ...
              <div className="relative my-3 flex items-center justify-center">
                ...
                <span className="absolute bg-white dark:bg-slate-800 px-3 text-xs text-slate-500 dark:text-slate-400 font-medium">
                  Or
                </span>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-2.5 px-4 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/60 text-slate-800 dark:text-white font-medium text-xs transition-all shadow-sm flex items-center justify-center gap-2.5 cursor-pointer"
              >
